...
- passive_only:
    ...
    with the target infrastructure, such as DNS resolution and HTTP
    probing, are denied.
...
class ExecutionPolicy:
    ...
    def allows(self, activity: ExecutionActivity) -> bool:
        ...
        # ExecutionConfig already validates the mode, so reaching this
        # branch indicates an unexpected internal state.
        return False
